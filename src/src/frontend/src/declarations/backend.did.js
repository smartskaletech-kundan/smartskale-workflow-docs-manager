...
export const idlService = IDL.Service({
  createProject: IDL.Func(
    [IDL.Text, IDL.Text, ProjectStatus, Priority, IDL.Opt(IDL.Int)],
    [Project],
    [],
  ),
  ...
  updateProject: IDL.Func(
    [IDL.Text, IDL.Text, IDL.Text, ProjectStatus, Priority, IDL.Opt(IDL.Int), IDL.Vec(IDL.Principal)],
    [IDL.Opt(Project)],
    [],
  ),
  ...
  createTask: IDL.Func(
    [IDL.Text, IDL.Text, IDL.Text, TaskStatus, Priority, IDL.Opt(IDL.Principal), IDL.Opt(IDL.Int), IDL.Vec(IDL.Text)],
    [Task],
    [],
  ),
